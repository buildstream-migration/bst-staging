...
# cas.add_object().
#
# Note that the format of bytes written in the buffer differ from
# `open("tmp", "w")` in a few important ways:
#
# - The line separator defaults to "\\n" instead of `os.linesep`.
# - The encoding defaults to utf-8 instead of `locale.getpreferredencoding()`.
#
