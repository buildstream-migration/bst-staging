    ...
    def _check(self):
        ...
        try:
            ...
            if e.code() == grpc.StatusCode.INVALID_ARGUMENT:
                ...
                raise RemoteError("Remote initialization failed with status {}: {}".format(e.code().name, e.details()))
        ...
        if self.spec.push:
            ...
            try:
                ...
                if e.code() == grpc.StatusCode.INVALID_ARGUMENT:
                    ...
                    raise RemoteError(
                        "Remote initialization failed with status {}: {}".format(e.code().name, e.details())
                    )
