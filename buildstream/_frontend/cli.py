...
def workspace_open(app, no_checkout, force, track_, elements, directory):
    ...
    with app.initialized(elements, rewritable=track_, track_elements=elements if track_ else None):
        ...
        for target in app.pipeline.targets:
            ...
            app.open_workspace(target, targetdir, no_checkout, track_, force)
