...
class ElementProxy(PluginProxy):
    ...
    def node_subst_vars(self, node: "ScalarNode") -> str:  # type: ignore[return]
        self._raise_illegal_call("Element.node_subst_vars")

    def node_subst_sequence_vars(self, node: "SequenceNode[ScalarNode]") -> List[str]:  # type: ignore[return]
        self._raise_illegal_call("Element.node_subst_sequence_vars")
